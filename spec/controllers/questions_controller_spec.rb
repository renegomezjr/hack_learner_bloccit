...
RSpec.describe QuestionsController, type: :controller do
  ...
  describe "GET #new" do
    ...
    it "instantiates @question" do
      get :new
      expect(assigns(:question)).not_to be nil
    end
  end

  describe "POST #create" do
    it "increases the number of question by 1" do
      expect{ post :create, question:{title: RandomData.random_sentence, body: random_paragraph, resolved: true} }.to change(Question,:count).by(1)
    end
